function header(){
    ...
    <div class="container">
      ...
      <div>
        <nav id="navOne">
            <ul>
              <li><a href="#"><span><i class="fa-light fa-bed"></i></span><span>Stays</span></a></li>
              <li><a href="#"><span><i class="fa-regular fa-car"></i></span><span>Cars</span></a></li>
              <li><a href="#"><span><i class="fa-thin fa-plane-up"></i></span><span>Flights</span></a></li>
              <li><a href="#"><span><i class="fa-light fa-suitcase"></i></span><span>Packages</span></a></li>
            </ul>
          </nav>
      </div>
      <div>
